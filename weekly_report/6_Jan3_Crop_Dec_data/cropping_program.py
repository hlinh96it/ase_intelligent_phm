...
# path_to_dataset = r"D:/OneDrive - NTHU/Projects and Papers/ASE_PHM_WireBonding/dataset"
...
for program_folder in program:
    if program_folder != '1、UMT2345OST02':
        continue
    ...
    for idx, crop_interval in enumerate(tqdm(crop_idx_pair)):
        ...
        print(pd.DataFrame.from_dict(cropped_index, orient='index'))
